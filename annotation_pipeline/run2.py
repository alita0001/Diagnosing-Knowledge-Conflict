...
使用方法：
    ...
    2. 修改配置或使用命令行参数：
       CUDA_VISIBLE_DEVICES=4 python -m annotation_pipeline.run2 --source_split_name image_vs_prior --push_intermediate_every 50
...
class PipelineConfig:
    ...
    source_dataset_name: str = "alita01/TriConflict-inference"
    source_subset_name: str = "llama-3.2v-11b-cot"  # Subset
    source_split_name: str = "image_vs_prior"

    # ===== 目标数据集配置 =====
    target_dataset_name: str = "1Jin1/TriConflict-annotations"
    target_subset_name: str = "Llama-3.2V-11B-Cot"  # Subset
    target_split_name: str = "image_vs_prior"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--source_dataset_name", type=str, default="alita01/TriConflict-inference",
                        help="源数据集名称,例如 alita01/TriConflict-inference")
    parser.add_argument("--source_subset_name", type=str, default="llama-3.2v-11b-cot",
                        help="源数据集子集名称，例如 R1-Onevision-7B")
    parser.add_argument("--source_split_name", type=str, default="image_vs_prior",
    ...
    parser.add_argument("--target_split_name", type=str, default="image_vs_prior",
